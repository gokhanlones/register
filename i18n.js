...
const TRANSLATIONS = {
    ...
    tr: {
        ...
        'dashboard.sun': 'Güneş',
        'dashboard.moon': 'Ay',
        'dashboard.rising': 'Yükselen',
        'dashboard.loadingSpinner': 'Gunluk yorum yukleniyor...',
        'dashboard.dailyHoroscope': 'Bugunun Gok Gunlugu',
        'dashboard.coreSelf': 'Özü Tanımla',
        'dashboard.mind': 'Zihin',
        'dashboard.loveRelating': 'İlişkiler',
        'dashboard.workPath': 'Kariyer',
        'dashboard.socialCollective': 'Sosyal',
        'dashboard.karmicHealing': 'Karma',
        'dashboard.luckyNumber': 'Şansli Sayı',
        'dashboard.luckyColor': 'Şanslı Renk',
        'dashboard.luckyTime': 'Şanslı Saat',
        ...
        'natal.title': 'Doğum Haritasi',
        'natal.pageTitle': 'Doğum Haritasi',
        'natal.loading': 'Doğum haritasi yükleniyor...',
        'natal.notFound': 'Doğum haritasi verisi bulunamadı.',
        'natal.loadingError': 'Veri yüklenirken hata oluştu.',
        'natal.planets': 'Gezegenler & Noktalar',
        'natal.houses': 'Evler',
        'natal.aspects': 'Açılar',
        'natal.angleDetails': 'Açı Detayları',
        'natal.interpretations': 'Yorumlar',
        'natal.retrograde': 'R',
        'natal.houseSuffix': '. Ev',
        'natal.chartPlaceholder': 'Harita görüntüsü mevcut değil',
        'natal.angleAsc': 'Yükselen (ASC)',
        'natal.angleMc': 'Orta Gök (MC)',
        ...
        'planet.pluto': 'Plüton',
        'planet.north_node': 'Kuzey Ay Düğümü',
    ...
    en: {
        ...
        'dashboard.coreSelf': 'Core Self',
        'dashboard.mind': 'Mind',
        'dashboard.loveRelating': 'Love',
        'dashboard.workPath': 'Career',
        'dashboard.socialCollective': 'Social',
        'dashboard.karmicHealing': 'Karmic',
